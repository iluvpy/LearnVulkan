...
void vSwapChain::createSwapChain(vDevice *device, vSurface *surface, Window *window) {
    ...
    QueueFamilyIndices indices = Util::findQueueFamilies(device->getVkphysicalDevice());
...
void vSwapChain::createImageViews(vDevice *device) {
    ...
    for (size_t i = 0; i < m_swapChainImages.size(); i++) {
        ...
        if (vkCreateImageView(device->getVKdevice(), &createInfo, nullptr, &m_swapChainImageViews[i]) != VK_SUCCESS) {
...
void vSwapChain::createFramebuffers(vDevice *device) {
    ...
    for (size_t i = 0; i < m_swapChainImageViews.size(); i++) {
        ...
        if (vkCreateFramebuffer(device->getVKdevice(), &framebufferInfo, nullptr, &m_swapChainFramebuffers[i]) != VK_SUCCESS) {
...
void vSwapChain::destroy(vDevice *device)  {
